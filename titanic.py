...
print()
print("Linear SVM")
score = cross_val_score(linear_svm, x_train, y_train, cv=5, scoring='accuracy')
precision = cross_val_score(linear_svm, x_train, y_train, cv=5, scoring='precision')
recall = cross_val_score(linear_svm, x_train, y_train, cv=5, scoring='recall')
f1Score = cross_val_score(linear_svm, x_train, y_train, cv=5, scoring='f1')
...
polynomial_svm = svm.SVC(kernel='poly', degree=2)
polynomial_svm.fit(x_train, y_train)
Y_pred = polynomial_svm.predict(x_test)
print()
print()
print("Polynomial SVM")
score = cross_val_score(polynomial_svm, x_train, y_train, cv=5, scoring='accuracy')
precision = cross_val_score(polynomial_svm, x_train, y_train, cv=5, scoring='precision')
recall = cross_val_score(polynomial_svm, x_train, y_train, cv=5, scoring='recall')
f1Score = cross_val_score(polynomial_svm, x_train, y_train, cv=5, scoring='f1')
...
print()
print("RBF SVM")
score = cross_val_score(rbf_svm, x_train, y_train, cv=5, scoring='accuracy')
precision = cross_val_score(rbf_svm, x_train, y_train, cv=5, scoring='precision')
recall = cross_val_score(rbf_svm, x_train, y_train, cv=5, scoring='recall')
f1Score = cross_val_score(rbf_svm, x_train, y_train, cv=5, scoring='f1')
